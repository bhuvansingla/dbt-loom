...
class ParadimeClient:
    ...
    def __init__(
        ...
        resolved_api_key = api_key or os.environ.get("PARADIME_API_KEY")
        resolved_api_secret = api_secret or os.environ.get("PARADIME_API_SECRET")
        resolved_api_endpoint = api_endpoint or os.environ.get("PARADIME_API_ENDPOINT")

        if not (resolved_api_key and resolved_api_secret and resolved_api_endpoint):
            raise Exception(
        ...
        self.api_endpoint = resolved_api_endpoint
